    ...
    const sendEmail = (e) => {
        ...
        emailjs
            ...
            .then(
                (result) => {
                    toast.success(
                        "Thank you! Email Send Successfully!"
                    );
            ...
            <form ref={form} onSubmit={sendEmail}>
                <div className="my-6 flex flex-col">
                    ...
                    <input
                        ...
                        name="from_name"
                        type="text "
                        className=" mt-2 border-b-2 text-base md:text-lg lg:text-xl xl:text-2xl border-[#B6BBC4] focus:outline-none bg-transparent w-full"
                    />
                </div>
                ...
                <div className="my-10 flex flex-col">
                    ...
                    <textarea
                        ...
                        name="message"
                        type="text"
                        className=" mt-2 border-2 p-4 rounded-sm text-base md:text-lg lg:text-xl xl:text-2xl border-[#B6BBC4] focus:outline-none bg-transparent w-full min-h-44 max-h-44" rows={4}
                    />
                </div>
